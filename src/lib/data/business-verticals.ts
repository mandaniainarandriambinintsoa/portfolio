...
const entries: BusinessVerticalEntry[] = [
  {
    ...
    fr: {
      ...
      searchTopics: ["création site agence de voyage", "site tour-opérateur", "site réservation circuits", "SEO agence de voyage"],
      proof: {
  ...
  },
  {
    ...
    fr: {
      ...
      searchTopics: ["création site garage automobile", "site internet garagiste", "site prise de rendez-vous garage", "SEO local garage"],
  ...
  },
  {
    ...
    fr: {
      ...
      searchTopics: ["création site entreprise BTP", "site internet entreprise construction", "site web rénovation", "site BTP diaspora"],
  ...
  },
  {
    ...
    fr: {
      ...
      title: "Création de site internet pour salon de beauté",
      metaTitle: "Création site salon de beauté et réservation",
      ...
      searchTopics: ["création site salon de beauté", "site institut de beauté", "site coiffeur réservation", "SEO local salon"],
      links: [
    ...
    en: {
      ...
      title: "Website development for beauty salons",
      metaTitle: "Beauty salon website and booking development",
  ...
  },
  {
    ...
    fr: {
      ...
      searchTopics: ["création site internet hôtel", "site réservation hôtel", "site web maison d'hôtes", "SEO hôtel"],
      links: [
  ...
  },
  {
    ...
    fr: {
      ...
      searchTopics: ["création site internet restaurant", "site web restaurant menu", "site réservation restaurant", "SEO local restaurant"],
      links: [
  ...
  },
  {
    ...
    fr: {
      ...
      title: "Création de site internet pour location de voiture",
      metaTitle: "Création site location de voiture",
      ...
      searchTopics: ["création site location voiture", "site agence location automobile", "site réservation véhicule", "logiciel location voiture"],
      links: [
