  ...
  return (
    <>
      ...
      <p>
        ...
        veuillez consulter notre <Link href="/privacy" className="text-indigo-400 hover:text-indigo-300">politique de confidentialité</Link>.
      </p>
  ...
  return (
    <>
      ...
      <p>
        ...
        please see our <Link href="/en/privacy" className="text-indigo-400 hover:text-indigo-300">privacy policy</Link>.
      </p>
